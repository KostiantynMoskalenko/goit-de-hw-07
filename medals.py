...
connection_name = "KostyaM_mysqldb"
...
with DAG(
    ...
    create_schema = MySqlOperator(
        ...
        sql="""
        CREATE DATABASE IF NOT EXISTS KostyaM;
        """
    )
    ...
    create_table = MySqlOperator(
        ...
        mysql_conn_id=connection_name,
        sql="""
        CREATE TABLE IF NOT EXISTS KostyaM.medals (
    ...
    count_Bronze = MySqlOperator(
        ...
        mysql_conn_id=connection_name,
        sql="""
            INSERT INTO KostyaM.medals (medal_type, count, created_at)
